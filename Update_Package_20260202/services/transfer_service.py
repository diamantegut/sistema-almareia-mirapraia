...
from services.logging_service import log_system_action
        ...
        with file_lock(lock_file):
            ...
            if restaurant_items:
                ...
                log_action(
                    ...
                    f"Mesa {table_id} -> Quarto {target_key} (Restaurante). Total: {rest_grand_total:.2f}",
                ...
                log_data = {
                    ...
                    'items': restaurant_items,
                    'user': user_name,
                    'description': f"Mesa {table_id} -> Quarto {target_key}"
                }
                log_system_action('transfer_to_room', log_data, user=user_name)
